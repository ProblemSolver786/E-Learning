...
<link rel="stylesheet" href="<?php echo base_url();?>web/css/creditly.css" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url();?>web/css/easy-responsive-tabs.css">
		...
		<div class="w3_agile_main_grids">
			<div class="w3layouts_main_grid_left">
				<div class="agileinfo_main_grid_left_grid">
					...
					<ul>
						<li>Course Details<span>2017 February 10, at 10:30 PM</span></li>
						<li></li>
					</ul>
				...
				<div class="wthree_payment_grid">
					...
					<div id="horizontalTab">
						<ul class="resp-tabs-list">
							<li><img src="<?php echo base_url();?>web/images/1.jpg" alt=" " /></li>
							<li><img src="<?php echo base_url();?>web/images/2.jpg" alt=" " /></li>
						</ul>
